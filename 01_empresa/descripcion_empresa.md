...
- **Servidores (CPD)**: infraestructura centralizada donde se alojan servicios y sistemas

Esta estructura está alineada con la segmentación de red mediante VLANs.
...
Cada tipo de usuario tendrá diferentes permisos y niveles de acceso dentro del sistema.
...
- Red local segmentada mediante VLANs
- Servidores para alojamiento de aplicaciones y bases de datos
- Sistema de gestión de usuarios y permisos
- Acceso a internet para todos los departamentos
- Red WiFi para empleados e invitados
...
## 6. Objetivo de la infraestructura
...
La infraestructura debe ser eficiente, segura y adaptada a un entorno profesional real.
